...
export default function Layout() {
  ...
  // Pure monochrome background - full height
  return (
    <div className="min-h-screen bg-transparent flex relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {/* Gradient overlay - REMOVED for clean aesthetic */}
        {/* Legacy: bg-gradient-to-br from-white/30 via-transparent to-white/20 */}

        {/* Animated blobs - REMOVED for premium minimal aesthetic */}
        {/* Legacy: Purple/Pink/Blue/Cyan/Yellow/Emerald gradients */}
        {/*
